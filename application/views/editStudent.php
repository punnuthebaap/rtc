            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                        <?php echo $title; ?>
                        <!-- <small>You can edit the student details below</small> -->
                        </h2>
                    </div>
                    <div class="body">
                        <div id="smartwizardEdit">
                            <ul class="nav">
                               <li>
                            ...
                            <div class="tab-content">
                               <div id="step-1" class="tab-pane" role="tabpanel">
                                <form id="edit_student_info" method="POST">
                                  <div class="row clearfix">
                                    <div style="padding-top: 25px;">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" name="admisstion_no" class="form-control" readonly required/>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group form-float br_select">
                                                <div class="form-line">
                                                    <select name="class" class="form-control show-tick" onchange="getsectionStuE()" required>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group form-float br_select">
                                                <div class="form-line">
                                                    <select name="section" id="studentAddSectionE1" class="form-control show-tick" required>
                                        ...
                                        <div class="row col-sm-12">
                                            ...
                                            <div class="col-sm-4" style="margin-top: 10px;">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-line">
                                                        <input type="date" id="studentAddDobE" name="dob" class="form-control" max="<?= date('Y-m-d'); ?>" placeholder="Date of birth" onblur="calcAgeE($('#studentAddDobE').val())"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row col-sm-12">
                                            ...
                                            <div class="col-sm-4" style="margin-top: 10px;">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-line">
                                                        <input type="date" name="addmition_date" class="form-control" max="<?= date('Y-m-d'); ?>" placeholder="Date of birth" required />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="number" id="studentAddAgeE" name="age" min="1" class="form-control" readonly />
                                        ...
                                        <div class="col-sm-8">
                                            <div class="form-group">
                                                ...
                                                <div class="form-line">
                                                    <input type="file" id="fileUploadStudent" name="fileUploadStudent" class="form-control" onchange ="uploadStudentPhotoE(event)"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-4 frame">
                                            <img id="studentPhotoFrameE" src="" style="width:100%;height: 100%;">
                                        </div>
                                        <div class="col-sm-4" style="display: none">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" id="student_photoE" name="student_photo" class="form-control"  readonly required />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                   <div class="row">
                                        <div class="col-md-12">
                                            <button id="editStudentInfo" class="btn btn-block bg-pink waves-effect" type="submit">Save</button>
                                        </div>
                                    </div>
                                </form>
                               </div>
                               <div id="step-2" class="tab-pane" role="tabpanel">
                                    <form id="edit_student_previous_detail" method="POST">
                                          <div class="row clearfix">
                                            <div class="header">
                                                <h2>
                                                Reference Details :
                                            ...
                                            <div class="row col-sm-12">
                                                <div class="col-sm-4">
                                                    <select name="sibling_class" class="form-control br_select show-tick" onchange="getsectionStuSibE()">
                                                            <option value="">Select a class *</option>
                                                           <?php foreach($class as $item){
                                                            echo '<option value="' . $item['class'] . '">' . $item['class'] . '</option>';
                                                            }
                                                ...
                                                <div class="col-sm-4">
                                                    <select name="sibling_section" id="sibling_sectionE" class="form-control br_select show-tick">
                                                            <option value="">Select a section *</option>
                                                    </select>
                                                </div>
                                                <div class="col-sm-4">
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-sm-6" style="margin-top: 10px;">
                                                <div class="form-group form-float">
                                                    ...
                                                    <div class="form-line">
                                                        <input type="date" max="<?= date('Y-m-d'); ?>" name="date_of_issue_certificate" class="form-control" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button id="editPreviousDetail" class="btn btn-block bg-pink waves-effect" type="submit">Save</button>
                                            </div>
                                        </div>
                                    </form>
                                   </div>
                                   <div id="step-3" class="tab-pane" role="tabpanel">
                                    <form id="edit_student_address" method="POST">
                                      <div class="row clearfix">
                                        <div class="header">
                                            <h2>
                                            Residential Address :
                                    ...
                                    <hr style="height: 2px;background: black;">
                                    <div class="demo-checkbox">
                                        <input type="checkbox" name="same_as_residential" id="same_as_residential" class="chk-col-red" onclick="sameAsResE()" />
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button id="editStudentAddress" class="btn btn-block bg-pink waves-effect" type="submit">Save</button>
                                            </div>
                                        </div>
                                    </form>
                                   </div>
                                   <div id="step-4" class="tab-pane" role="tabpanel">
                                    <form id="edit_student_parents_details" method="POST">
                                      <div class="row clearfix">
                                        <div class="header">
                                            <h2>
                                            Father's Info :
                                        ...
                                        <div class="row col-sm-12" style="margin-top: 14px;">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="form-group">
                                                        <label class="form-label">Upload File</label>
                                                    <div class="form-line">
                                                        <input type="file" id="fileUploadFather" name="fileUploadFather" class="form-control" onchange ="uploadFatherPhotoE(event)"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-4 frame">
                                                <img id="fatherPhotoFrameE" src="" style="width:100%;height: 100%;">
                                            </div>
                                            <div class="col-sm-4" style="display: none">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input type="text" id="father_photoE" name="father_photo" class="form-control"  readonly />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="row col-sm-12" style="margin-top: 14px;">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group form-float">
                                                    <div class="form-line">
                                                        <input type="text" name="M_email_ID" class="form-control" />
                                                        <label class="form-label">Email Id</label>
                                                    </div>
                                                </div>
                                            </div>
                                             <div class="col-sm-8">
                                                <div class="form-group">
                                                        <label class="form-label">Upload File</label>
                                                    <div class="form-line">
                                                        <input type="file" id="fileUploadMother" name="fileUploadMother" class="form-control" onchange ="uploadMotherPhotoE(event)"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-4 frame">
                                                <img id="motherPhotoFrameE" src="" style="width:100%;height: 100%;">
                                            </div>
                                            <div class="col-sm-4" style="display: none">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input type="text" id="mother_photoE" name="mother_photo" class="form-control"  readonly />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row clearfix">
                                            ...
                                            <div class="row col-sm-12" style="margin-top: 14px;">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group form-float">
                                                        <div class="form-line">
                                                            <input type="text" name="G_Email_ID" class="form-control" />
                                                            <label class="form-label">Email Id</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-8">
                                                    <div class="form-group">
                                                            <label class="form-label">Upload File</label>
                                                        <div class="form-line">
                                                            <input type="file" id="fileUploadGuardian" name="fileUploadGuardian" class="form-control" onchange ="uploadGuardianPhotoE(event)" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4 frame">
                                                    <img id="guardianPhotoFrameE" src="" style="width:100%;height: 100%;">
                                                </div>
                                                <div class="col-sm-4" style="display: none">
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <input type="text" id="gurdian_photoE" name="gurdian_photo" class="form-control"  readonly />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                            <div class="col-md-12">
                                                <button id="editStudentParents" class="btn btn-block bg-pink waves-effect" type="submit">Save</button>
                                            </div>
                                    </div>
                                </form>
                               </div>
                               <div id="step-5" class="tab-pane" role="tabpanel">
                                <form id="edit_student_optional" method="POST">
                                  <div class="row clearfix">
                                    <div class="header">
                                        <h2>
                                        Optional Subject :
                                    ...
                                    <div class="row col-sm-12" style="margin-top: 14px;">
                                     ...
                                     <div class="row">
                                        <div class="col-md-12">
                                            <button id="editStudentOptional" class="btn btn-block bg-pink waves-effect" type="submit">Save</button>
                                        </div>
                                    </div>
                                 </form>
                               </div>

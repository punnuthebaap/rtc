            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                        <?php echo $title; ?>
                        <!-- <small>You can edit the details for the below assignment:</small> -->
                        </h2>
                    </div>
                    <div class="body">
                        <form id="edit_assignment" enctype="multipart/form-data" method="POST">
                            <div class="row clearfix">
                                <div class="col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <select id="classSubject" name="class" class="form-control show-tick" onchange="getsectionedit()" required>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <select name="section" id="sectionAddAssign" class="form-control show-tick" onchange="getsubjectedit()" required>
                                ...
                                <div class="col-sm-8">
                                    <div class="form-group">
                                        ...
                                        <div class="form-line">
                                            <input type="file" id="fileUploadAssign" name="fileUploadAssign" class="form-control" onchange ="uploadAssignmentFileEdit(event)"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <button id="onEditAssignment" class="btn btn-block bg-pink waves-effect" type="submit">Edit Assignment</button>
                                </div>
                            </div>
                        </form>
                    </div>

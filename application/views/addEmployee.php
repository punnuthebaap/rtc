                ...
                <div class="card">
                    <div class="header">
                        ...
                        <form id="add_employee" method="POST">
                                    ...
                                    <div class="col-sm-12" style="margin-bottom:20px;">
                                        <div class="col-sm-8">
                                            <div class="form-group">
                                                ...
                                                <div class="form-line">
                                                    <input type="file" id="fileUploadEmployee" name="fileUploadEmployee" class="form-control" onchange ="uploadEmployeePhoto(event)"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-4 frame">
                                            <img id="employeePhotoFrame" src="" style="width:100%;height: 100%;">
                                        </div>
                                        <div class="col-sm-4" style="display: none">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" id="employee_photo" name="employee_photo" class="form-control"  readonly required />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <button id="onAddEmployee" class="btn btn-block bg-pink waves-effect" type="submit">Add Employee</button>
                                </div>
                            </div>
                        </form>
                    </div>
